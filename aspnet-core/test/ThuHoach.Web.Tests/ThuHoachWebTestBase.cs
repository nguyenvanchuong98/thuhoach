...
{
    public abstract class ThuHoachWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ThuHoachWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ThuHoachWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ThuHoachDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ThuHoachDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ThuHoachDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ThuHoachDbContext, Task<T>> func)
        {
            T result;
